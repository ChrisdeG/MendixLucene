...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(lucene.actions.BackupCreateInFiledocument.class);
			component.actionRegistry().registerUserAction(lucene.actions.BackupRestoreFromFiledocument.class);
			component.actionRegistry().registerUserAction(lucene.actions.DeleteFromIndex.class);
			component.actionRegistry().registerUserAction(lucene.actions.DeleteIndex.class);
			component.actionRegistry().registerUserAction(lucene.actions.EscapeCharacters.class);
			component.actionRegistry().registerUserAction(lucene.actions.ExtractTextFromHTML.class);
			component.actionRegistry().registerUserAction(lucene.actions.GetIndexSize.class);
			component.actionRegistry().registerUserAction(lucene.actions.SearchIndex.class);
			component.actionRegistry().registerUserAction(lucene.actions.UpdateIndex.class);
			component.actionRegistry().registerUserAction(lucene.actions.UpdateIndexFileDocument.class);
			component.actionRegistry().registerUserAction(lucene.actions.WaitUntilIndexingReady.class);
