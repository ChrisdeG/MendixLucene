...
public class FileDocument
{
	...
	public static system.proxies.FileDocument initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("Lucene.LuceneBackup", mendixObject.getType()))
			return lucene.proxies.LuceneBackup.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("UnitTest.Report", mendixObject.getType()))
			return unittest.proxies.Report.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("Lucene.SampleFileDocument", mendixObject.getType()))
